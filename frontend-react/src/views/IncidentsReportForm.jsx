...
const IncidentReportForm = () => {
    ...
    return (
        <div className="p-6 bg-white rounded-xl shadow-md">
            <h2 className="text-2xl font-semibold mb-4">Submit Incident Report</h2>
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4">My Submitted Reports</h2>
                    ...
                    <tbody>
                        {reports.map((report) => (
                            <tr key={report.id} className="text-center">
                                ...
                                <td className="p-2 border border-green-900">{report.description}</td>
                                <td className="p-2 border border-green-900">{report.date}</td>
                                <td className="p-2 border border-green-900">{report.severity}</td>
